...
admin = {first_name: "jake", last_name: "Shawn", email: "admin@nexarestore.com", mobile:"9887788899", gender:"male", street: "107", city: "Gort", country: "Newzeeland", admin_role: true, user_role: false, name: "Jake Shawn", password: "password123", password_confirmation: "password123"}
user = User.new(admin)
user.save
